...
import (
	...
	"github.com/jackgris/greenlight/internal/jsonlog"
	"github.com/jackgris/greenlight/internal/mailer"
	_ "github.com/lib/pq"
)
...
func main() {
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.jackgris.net>", "SMTP sender")
